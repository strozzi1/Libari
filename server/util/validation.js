 ...
 */
export const validateAgainstSchema = function (obj, schema) {
    return obj && Object.keys(schema).every(
      field => !schema[field].required || obj.hasOwnProperty(field)
    );
  };
   ...
   * original object.
   */
export const extractValidFields = function (obj, schema) {
    let validObj = {};
